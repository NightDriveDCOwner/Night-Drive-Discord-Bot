...
class Tmp(commands.Cog):
    ...
    async def on_ready(self):
        self.verified_role = self.bot.guilds[0].get_role(1066793314482913391)
    ...
    @exception_handler
    async def _badword_add(self, inter: disnake.ApplicationCommandInteraction, word: str):
    ...
    @exception_handler
    async def _badword_remove(self, inter: disnake.ApplicationCommandInteraction, word: str):
    ...
    @exception_handler
    async def _badwords_list(self, inter: disnake.ApplicationCommandInteraction):
    ...
    @exception_handler
    async def _note_delete(self, inter: disnake.ApplicationCommandInteraction, caseid: int):
    ...
    @exception_handler
    async def _eorganize_database(self, inter: ApplicationCommandInteraction):
